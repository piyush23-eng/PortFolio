        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {TECHNICAL_CATEGORIES.map((cat, idx) => (
            <div
              ...
              className="p-8 sm:p-10 rounded-3xl bg-white border border-black/[0.08] shadow-[0_4px_24px_rgba(0,0,0,0.03)] hover:shadow-[0_12px_36px_rgba(0,0,0,0.07)] hover:border-black/[0.2] transition-all flex flex-col justify-between group"
            >
              <div>
